...
// in simulator we redefine to format for wtfisthis Developer console
...
{\
	NSString * exceptionName = [@"org.wtfisthis." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wtfisthis";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIwtfisthisNativeItemNone = -1, 
	UIwtfisthisNativeItemSpinner = -2,
	UIwtfisthisNativeItemProgressBar = -3,
	
	UIwtfisthisNativeItemSlider = -4,
	UIwtfisthisNativeItemSwitch = -5,
	UIwtfisthisNativeItemMultiButton = -6,
	UIwtfisthisNativeItemSegmented = -7,
	
	UIwtfisthisNativeItemTextView = -8,
	UIwtfisthisNativeItemTextField = -9,
	UIwtfisthisNativeItemSearchBar = -10,
	
	UIwtfisthisNativeItemPicker = -11,
	UIwtfisthisNativeItemDatePicker = -12,
	
	UIwtfisthisNativeItemInfoLight = -13,
	UIwtfisthisNativeItemInfoDark = -14,
	
	UIwtfisthisNativeItemDisclosure = -15,
	
	UIwtfisthisNativeItemContactAdd = -16
};
