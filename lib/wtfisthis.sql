...
CREATE TABLE `answers` (
  ...
  `name` varchar(50) COLLATE utf8_swedish_ci DEFAULT 'Anonym',
...
INSERT INTO `answers` (`answer_id`, `question_id`, `answer_text`, `published_time`) VALUES
(14,	6,	'Joker celebrates new year\'s eve.',	'2010-12-31 23:49:45'),
(16,	1,	'we have some really good Supercalifragilisticexpialidocious Supercalifragilisticexpialidocious Supercalifragilisticexpialidocious Supercalifragilisticexpialidocious right there.',	'2011-02-05 15:43:08'),
(17,	4,	'Enligt hemsidan \"Django is a high-level Python Web framework that encourages rapid development and clean, pragmatic design.\" Det är djangos logga.',	'2011-01-19 15:19:52'),
(18,	4,	'kanske det? Något programspråkrelaterat iaf',	'2011-02-10 15:19:43'),
(19,	4,	'Ser ut som en ponny enligt mig...',	'2011-02-12 15:19:31'),
(20,	4,	'Knappast, det är en enhörning!',	'2011-02-17 10:58:13'),
(21,	4,	'Jag tror det är Visual basic som har det som logotyp.',	'2011-02-15 15:19:22');

DROP TABLE IF EXISTS `questions`;
CREATE TABLE `questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(160) COLLATE utf8_bin NOT NULL,
  `author` varchar(50) COLLATE utf8_bin DEFAULT 'Anonym',
...
INSERT INTO `questions` (`id`, `author`, `post_date`, `title`,  `description`, `photo_id`, `thumbnail`, `medium`, `original`) VALUES
(7,	'Sten-Åke Strid',	'2011-02-09 14:38:02',	'Vem är det här?',	'Sten-Åke undrar vad det här är bra för. Jag vet ju själv vem jag är...',	5450004171,	NULL,	NULL,	NULL);
